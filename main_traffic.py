...
train_model(net_gru_dilate,loss_type='dilate',learning_rate=0.0005, epochs=500, gamma=gamma, print_every=5)
...
train_model(net_gru_soft_dtw,loss_type='dilate',learning_rate=0.0005, epochs=500, gamma=gamma, alpha =1, print_every=5)
