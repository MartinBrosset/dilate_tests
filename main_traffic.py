...
train_model(net_gru_mse,loss_type='mse',learning_rate=0.001, epochs=300, gamma=gamma, print_every=5)
...
train_model(net_gru_dilate,loss_type='dilate',learning_rate=0.001, epochs=500, gamma=gamma, print_every=5)
