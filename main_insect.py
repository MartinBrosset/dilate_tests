...
train_model(net_gru_dilate,loss_type='dilate',learning_rate=0.005, epochs=50, gamma=gamma, alpha=0.5, print_every=5)
...
train_model(net_gru_mse,loss_type='mse',learning_rate=0.001, epochs=50, gamma=gamma, print_every=5)
...
train_model(net_gru_soft_dtw,loss_type='dilate',learning_rate=0.005, epochs=50, gamma=gamma, alpha =1, print_every=5)
