...
train_model(net_gru_dilate,loss_type='dilate',learning_rate=0.1, epochs=300, gamma=gamma, alpha=0.7, print_every=5)
...
train_model(net_gru_soft_dtw,loss_type='dilate',learning_rate=0.1, epochs=200, gamma=gamma, alpha =1, print_every=5)
